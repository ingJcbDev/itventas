...
class Articulo {
	...
	{
		$sql="UPDATE articulo SET idcategoria='$idcategoria', codigo='$codigo', nombre='$nombre', stock='$stock', descripcion='$descripcion', descripcion='$descripcion' WHERE idarticulo='$idarticulo'";
		return ejecutarConsulta($sql);
	}
